...
class PC_UNet(torch.nn.Module):
    ...
    def __init__(self, n_channels, n_classes, n_filts=32):
        ...
        self.cnv11 = PCBlock(n_channels, n_filts, k=3, inv_fctr=3)
        self.cnv12 = PCBlock(n_filts, n_filts, k=3, inv_fctr=3)

        self.cnv21 = PCBlock(n_filts, n_filts * 2, k=3, inv_fctr=3)
        self.cnv22 = PCBlock(n_filts * 2, n_filts * 2, k=3, inv_fctr=3)

        self.cnv31 = PCBlock(n_filts * 2, n_filts * 4, k=3, inv_fctr=3)
        self.cnv32 = PCBlock(n_filts * 4, n_filts * 4, k=3, inv_fctr=3)

        self.cnv41 = PCBlock(n_filts * 4, n_filts * 8, k=3, inv_fctr=3)
        self.cnv42 = PCBlock(n_filts * 8, n_filts * 8, k=3, inv_fctr=3)

        self.cnv51 = PCBlock(n_filts * 8, n_filts * 16, k=3, inv_fctr=3)
        self.cnv52 = PCBlock(n_filts * 16, n_filts * 16, k=3, inv_fctr=3)
        ...
        self.cnv61 = PCBlock(n_filts * 8 + n_filts * 8, n_filts * 8, k=3, inv_fctr=3)
        self.cnv62 = PCBlock(n_filts * 8, n_filts * 8, k=3, inv_fctr=3)

        self.up7 = torch.nn.ConvTranspose2d(n_filts * 8, n_filts * 4, kernel_size=(2, 2), stride=2)
        self.cnv71 = PCBlock(n_filts * 4 + n_filts * 4, n_filts * 4, k=3, inv_fctr=3)
        self.cnv72 = PCBlock(n_filts * 4, n_filts * 4, k=3, inv_fctr=34)

        self.up8 = torch.nn.ConvTranspose2d(n_filts * 4, n_filts * 2, kernel_size=(2, 2), stride=2)
        self.cnv81 = PCBlock(n_filts * 2 + n_filts * 2, n_filts * 2, k=3, inv_fctr=3)
        self.cnv82 = PCBlock(n_filts * 2, n_filts * 2, k=3, inv_fctr=3)

        self.up9 = torch.nn.ConvTranspose2d(n_filts * 2, n_filts, kernel_size=(2, 2), stride=2)
        self.cnv91 = PCBlock(n_filts + n_filts, n_filts, k=3, inv_fctr=3)
        self.cnv92 = PCBlock(n_filts, n_filts, k=3, inv_fctr=3)
...
class PCBlock(torch.nn.Module):
    ...
    def __init__(self, n_filts, out_channels, k=3, inv_fctr=3):
        ...
        self.FEC = PCLayer(n_filts, n_filts, k)
